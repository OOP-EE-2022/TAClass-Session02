...
public class Main {
    public static void main(String[] args) {
        String txt = "ashahbazi750n@gmail.com\n" +
        ...
        ArrayList<String> yahooList = new ArrayList<>();
        ...
        while (matcher.find()) {
            if (matcher.group(1).equals("gmail")) {
                if (!gmailList.contains(matcher.group())) {
                    gmailList.add(matcher.group());
                }
            } else if (matcher.group(1).equals("yahoo")) {
                if (!yahooList.contains(matcher.group())) {
                    yahooList.add(matcher.group());
                }
            } else {
                if (!extraList.contains(matcher.group())) {
                    extraList.add(matcher.group());
                }
            }
            hashMap.put(index, matcher.group());
            index++;
        }
        ...
        extraList.remove("soroushtabatabaee@icloud.com");
